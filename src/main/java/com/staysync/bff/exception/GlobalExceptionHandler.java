...
public class GlobalExceptionHandler {
    ...
    // Propaga errores 4xx del downstream (ej: 404 Not Found, 409 Conflict) tal como vienen
    ...
    public ResponseEntity<Map<String, Object>> handleClientError(HttpClientErrorException ex) {
        ...
        return build(HttpStatus.valueOf(ex.getStatusCode().value()), ex.getResponseBodyAsString());
    }
